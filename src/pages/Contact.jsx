    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.mainCard}>
          ...
          <h2 style={styles.cardTitle}>李阳</h2>
          ...
          {[
            ...
            <div key={item.label} style={styles.contactItem}>
              ...
              <div style={styles.contactInfo}>
                ...
                {item.href ? (
                  <a href={item.href} style={styles.contactValueLink}>{item.value}</a>
                ) : (
        ...
        <div style={styles.quickLinks}>
          ...
          <div style={styles.quickGrid}>
            {[
              ...
              <a key={link.label} href={link.href} style={{ ...styles.quickBtn, borderColor: `${link.color}40`, color: link.color }}>
                {link.label}
              </a>
            ))}
          </div>
